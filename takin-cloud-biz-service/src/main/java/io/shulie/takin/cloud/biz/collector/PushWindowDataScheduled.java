...
public class PushWindowDataScheduled extends AbstractIndicators {
    ...
    private Long reduceMetrics(ReportEntity report, Integer podNum, long endTime, Long timeWindow, List<ScriptNode> nodes) {
        if (null == report) {
            return null;
        }
    ...
    private void finishPushData(ReportEntity report, Integer podNum, Long timeWindow,
