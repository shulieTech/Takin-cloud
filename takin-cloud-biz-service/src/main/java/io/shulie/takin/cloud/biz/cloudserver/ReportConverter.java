...
public interface ReportConverter {
    ...
    /**
     * 转换 {@link com.pamirs.takin.entity.domain.entity.report.Report } -> {@link com.pamirs.takin.entity.domain.dto.report.CloudReportDTO}
     *
     * @param report {@link com.pamirs.takin.entity.domain.entity.report.Report }
     * @return {@link com.pamirs.takin.entity.domain.dto.report.CloudReportDTO}
     */
    @Mappings({
    ...
    /**
     * 转换 {@link com.pamirs.takin.entity.domain.entity.scene.manage.WarnDetail} -> {@link WarnDetailResult}
     *
     * @param warnDetail {@link com.pamirs.takin.entity.domain.entity.scene.manage.WarnDetail}
