...
BEGIN
	...
	THEN
ALTER TABLE t_report ADD customer_id bigint(20) COMMENT '租户字段，customer_id,custom_id已废弃';
END IF;
END $$
DELIMITER ;
CALL add_column;

update t_report set customer_id = custom_id;
...
BEGIN
	...
	THEN
ALTER TABLE t_scene_manage ADD customer_id bigint(20) COMMENT '租户字段，customer_id,custom_id已废弃';
END IF;
END $$
DELIMITER ;
CALL add_column;

update t_scene_manage set customer_id = custom_id;
