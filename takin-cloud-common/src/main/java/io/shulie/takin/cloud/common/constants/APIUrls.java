...
public class APIUrls {
    ...
    public static final String API_TRO_CONFCENTER_ADD_BLIST_URI = API_TRO_CONFCENTER_URI + "wbmnt/add/blist";
    // API.01.02.008 查询黑名单列表
    public static final String API_TRO_CONFCENTER_QUERY_BLIST_URI = API_TRO_CONFCENTER_URI + "wbmnt/query/blist";
    ...
    public static final String API_TRO_CONFCENTER_UPDATE_BLIST_URI = API_TRO_CONFCENTER_URI + "wbmnt/update/blist";
    // API.01.02.011 删除黑名单接口
    public static final String API_TRO_CONFCENTER_DELETE_BLIST_URI = API_TRO_CONFCENTER_URI + "wbmnt/delete/blist";

    // API.01.02.012  查询黑白名单列表
    public static final String API_TRO_CONFCENTER_QUERY_BWLIST_URI = API_TRO_CONFCENTER_URI + "wbmnt/query/bwlist";

    // API.01.02.013  查询黑白名单列表 提供metrics特殊使用
    public static final String API_TRO_CONFCENTER_QUERY_BWLISTMETRIC_URI = API_TRO_CONFCENTER_URI
    ...
    public static final String API_TRO_CONFCENTER_INTERFACE_NEED_UPLOAD_URL = API_TRO_CONFCENTER_URI
        + "interface/query/needUpload";
    // API.01.07.001 上传 dubbo与job数据
    public static final String API_TRO_CONFCENTER_INTERFACE_UPLOAD_URL = API_TRO_CONFCENTER_URI
