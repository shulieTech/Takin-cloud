...
(
  ...
  COLLATE = utf8_bin COMMENT ='引擎插件文件信息';

-- ----------------------------
-- Records of t_engine_plugin_files_ref
-- ----------------------------
BEGIN;
INSERT INTO `t_engine_plugin_files_ref`
VALUES (1, 1, 'jmeter-plugins-dubbo-all.jar', '/engine/plugins/dubbo/dubbo-all/jmeter-plugins-dubbo-all.jar', '2021-01-29 13:43:59');
INSERT INTO `t_engine_plugin_files_ref`
VALUES (2, 2, 'jmeter-plugins-kafka-all.jar', '/engine/plugins/kafka/kafka-all/jmeter-plugins-kafka-all.jar', '2021-01-29 13:44:48');
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 40
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin COMMENT ='压力引擎插件配置信息';
...
VALUES (1, 'dubbo', 'dubbo-all', '2021-01-06 14:43:58', '2021-01-06 14:43:58', 1);
INSERT INTO `t_engine_plugin_info`
VALUES (2, 'kafka', 'kafka-all', '2021-01-06 14:44:33', '2021-01-06 14:44:33', 1);
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 88
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin COMMENT ='压力引擎插件支持的版本信息';

-- ----------------------------
-- Records of t_engine_plugin_supported_versions
-- ----------------------------
BEGIN;
INSERT INTO `t_engine_plugin_supported_versions`
VALUES (1, 1, 'all');
INSERT INTO `t_engine_plugin_supported_versions`
VALUES (2, 2, 'all');
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 116
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin COMMENT ='调度记录引擎插件信息';
